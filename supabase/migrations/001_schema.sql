...
-- ============================================================
-- Auto-inserts notification rows for the 4 events in scope: new bid, bid
-- accepted, job completed, payment received. Clients can never insert into
-- notifications directly (see the notifications RLS policies above) --
